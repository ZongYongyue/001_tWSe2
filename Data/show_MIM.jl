...
sdfg = loadData("./using/PaperData/L12MIM_SU4p7_SDFG.jls")
so_sdfg = loadData("./using/PaperData/L12MIM_SO_SU4p7_SDFG.jls")
...
for i in 1:21
    ...
    savefig(f, "./result/PaperData_MIM/L12MIM_Fermi_$i.pdf")
    ...
    plot!(x, y, seriestype=:path, linecolor=:white, linestyle=:dot, linewidth=2.5, legend=false, aspect_ratio=1)
    savefig(fu, "./result/PaperData_MIM/L12MIM_Fermi_spinup_$i.pdf")
    ...
    plot!(x, y, seriestype=:path, linecolor=:white, linestyle=:dot, linewidth=2.5, legend=false, aspect_ratio=1)
    savefig(gfu, "./result/PaperData_MIM/L12MIM_Gre_Fermi_spinup_$i.pdf")
...
for i in 1:21
    ...
    plot!(x, y, seriestype=:path, linecolor=:white, linestyle=:dot, linewidth=2.5, legend=false, aspect_ratio=1)
    savefig(f, "./result/PaperData_MIM_SO/SO_L12MIM_Fermi_$i.pdf")

    cls3 = (0, 0.15)
    fu = heatmap(range(-2pi,2pi,1000),range(-2pi,2pi,1000),so_sdfg[i][6], ratio=1, color=colorbar,clims=cls3,title="Density of spin up states on fermisurface")
    plot!(x, y, seriestype=:path, linecolor=:white, linestyle=:dot, linewidth=2.5, legend=false, aspect_ratio=1)
    savefig(fu, "./result/PaperData_MIM_SO/SO_L12MIM_Fermi_spinup_$i.pdf")

    fd = heatmap(range(-2pi,2pi,1000),range(-2pi,2pi,1000),so_sdfg[i][7], ratio=1, color=colorbar,clims=cls3,title="Density of spin down states on fermisurface")
    plot!(x, y, seriestype=:path, linecolor=:white, linestyle=:dot, linewidth=2.5, legend=false, aspect_ratio=1)
    savefig(fd, "./result/PaperData_MIM_SO/SO_L12MIM_Fermi_spindown_$i.pdf")
    
    cls2 = (-0.3, 0.3)

    gsu = plot(k_path, ω_range, so_sdfg[i][8]; xlabel="k", ylabel="ω", color=colorbarg, title="Spectral Function spin-up",clims=cls2)
    savefig(gsu, "./result/PaperData_MIM_SO/SO_L12MIM_Gre_Spec_spinup_$i.pdf")

    gsd = plot(k_path, ω_range, so_sdfg[i][9]; xlabel="k", ylabel="ω", color=colorbarg, title="Spectral Function spin-down",clims=cls2)
    savefig(gsd, "./result/PaperData_MIM_SO/SO_L12MIM_Gre_Spec_spindown_$i.pdf")
    ...
    plot!(x, y, seriestype=:path, linecolor=:white, linestyle=:dot, linewidth=2.5, legend=false, aspect_ratio=1)
    savefig(gfu, "./result/PaperData_MIM_SO/SO_L12MIM_Gre_Fermi_spinup_$i.pdf")
    ...
    plot!(x, y, seriestype=:path, linecolor=:white, linestyle=:dot, linewidth=2.5, legend=false, aspect_ratio=1)
    savefig(gfd, "./result/PaperData_MIM_SO/SO_L12MIM_Gre_Fermi_spindown_$i.pdf")
end
=#
...
cls2 = (-0.3, 0.3)
i=4
gsd = plot(k_path, ω_range[50:300], so_sdfg[i][9][50:300,:]; xlabel="k", ylabel="ω", color=colorbarg, title="Spectral Function spin-down",clims=cls2, size=(400,400), colorbar=false)
#savefig(gsd, "./result/PaperData_MIM_SO/SO_L12MIM_Gre_Spec_spindown_$i.pdf")
plot!(gsd, k_path,zeros(length(k_path)), color=:black, ls=:dash)

savefig(gsd, "./result/PaperFig/Ex5_1.pdf")

cls2 = (-0.3, 0.3)
i=16
gsd = plot(k_path, ω_range[50:400], so_sdfg[i][9][50:400,:]; xlabel="k", ylabel="ω", color=colorbarg, title="Spectral Function spin-down",clims=cls2, size=(400,400), colorbar=false)
#savefig(gsd, "./result/PaperData_MIM_SO/SO_L12MIM_Gre_Spec_spindown_$i.pdf")
plot!(gsd, k_path,zeros(length(k_path)), color=:black, ls=:dash)

savefig(gsd, "./result/PaperFig/Ex5_2.pdf")